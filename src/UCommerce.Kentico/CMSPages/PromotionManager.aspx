<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../../../CMSMasterPages/ui/simplePage.master" CodeBehind="PromotionManager.aspx.cs" theme="default" Inherits="UCommerce.Kentico.CMSPages.PromotionManager" %>
...
<asp:Content ID="ucommerceContent" ContentPlaceHolderID="plcContent" runat="server">
    ...
    <ucommerce-shell content-picker-type="MarketingApp" tree-indetion-size="31" fixed-left-size="300px" disable-resize="true" start-page="../Marketing/MarketingStartPage.aspx"></ucommerce-shell>    
